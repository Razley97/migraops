export var i18n = {
  es: {
    ...
    rateLimitWait:"Esperando restablecimiento del límite...",rateLimitRetry:"Reintento {n}/{max} en {s}s",phaseSkipped:"Fase omitida por límites de API",freeTierNote:"Proveedor gratuito — la migración puede tomar más tiempo por límites de API",interPhaseCooldown:"Pausa entre fases..."
  },
  en: {
    ...
    rateLimitWait:"Waiting for rate limit reset...",rateLimitRetry:"Retry {n}/{max} in {s}s",phaseSkipped:"Phase skipped due to API limits",freeTierNote:"Free provider — migration may take longer due to API limits",interPhaseCooldown:"Cooling down between phases..."
  },
  pt: {
    ...
    rateLimitWait:"Aguardando reset do limite...",rateLimitRetry:"Tentativa {n}/{max} em {s}s",phaseSkipped:"Fase omitida por limites da API",freeTierNote:"Provedor gratuito — a migração pode levar mais tempo por limites da API",interPhaseCooldown:"Pausa entre fases..."
  }
};
